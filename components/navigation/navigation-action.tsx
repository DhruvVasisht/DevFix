...
const NavigationAction = () => {
  ...
  return (
    <div>
     <ActionTooltip label="New Codespace" side="right" align="center">
  <button onClick={()=>onOpen("createServer")} className="group flex items-center">
    <div
      ...
      group-hover:bg-emerald-500 dark:group-hover:bg-emerald-500 cursor-pointer"
    >
      <Plus
        className="transition text-emerald-500 group-hover:text-white dark:group-hover:text-white"
        size={25}
      />
    </div>
  </button>
